...
export interface MasterChef extends BaseContract {
  ...
  functions: {
    ...
    grayPerBlock(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    grayPerBlock(overrides?: CallOverrides): Promise<PopulatedTransaction>;
